...
<footer className="footer p-10 bg-[#e2e6ff]  text-[#2a2a2a] rounded-md">
  <nav>
    ...
    <Link to="#" className="link link-hover ">Surveys Page</Link> 
    <Link to="#" className="link link-hover ">Go Pro</Link> 
...
<small>AllRights Reserved. Powered by the SurveySphere</small>
</div>
